...
Use a verified document-generation capability currently exposed by the runtime to create the 8-12 page report. If none is available, stop before claiming a DOCX deliverable and report the missing capability.
