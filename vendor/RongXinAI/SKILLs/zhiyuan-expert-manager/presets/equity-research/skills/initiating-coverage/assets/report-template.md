...
**NOTE:** The actual report MUST be created with a verified document-generation capability currently exposed by the runtime. DO NOT generate markdown content as the final artifact.

**CRITICAL REQUIREMENTS:**
1. **Generate 20-30+ chart images** using Python (matplotlib/plotly) BEFORE creating the Word document
2. **Use the selected document capability**: Create a professional report with proper styles, headers/footers, and formatting
3. **Embed actual chart images**: Insert the generated PNG/JPG chart files into the Word document at appropriate locations
4. **NO MARKDOWN AS FINAL OUTPUT**: Use the selected document capability to create a .docx file.
...
- **20-30+ ACTUAL CHART IMAGES**: Generate charts as image files, then embed them with the selected document capability.
